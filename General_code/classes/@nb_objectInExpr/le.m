...
% Description:
% 
% This method is intended to test if a nb_math_ts object is less than 
% or equal to another. We therefore just return the a object here as the  
% date the objects represent does not change in this case.
%
% Input:
% 
