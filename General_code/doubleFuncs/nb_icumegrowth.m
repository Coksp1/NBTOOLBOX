function dout = nb_icumegrowth(din,d0,omitnan)
% Syntax: 
%
% - dout = nb_icumegrowth(din,d0,omitnan)
%
% Description:
%
% Inverse of the cumulative growth method nb_cumegrowth
% 
% Input:
%
...
function dout = subFunc(din,d0)
    ...
    dout            = nan(r,c,p);
    dout(1,:,:)     = d0;
    dout(2:end,:,:) = bsxfun(@times,(1 + din(2:end,:,:)),d0);
