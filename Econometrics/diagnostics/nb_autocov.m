function [acf,lBound,uBound] = nb_autocov(y,lags,errorBound,alpha,varargin)
% Syntax:
%
...
%
% - lBound : Lower bound of the error bound of the autocovariance
%            function. As a lags x nvar double. 
%
% - uBound : Upper bound of the error bound of the autocovariance
%            function. As a lags x nvar double. 
%
        ...
        switch lower(errorBound)
            ...
            otherwise
                ...
                for ii = 1:numPage
                    ...
                    % Estimate the autocorrelation for each 
                    % draw
                    simACF = nb_autocov(simTemp,lags);
