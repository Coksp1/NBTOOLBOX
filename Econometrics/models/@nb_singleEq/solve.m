...
% Output:
% 
% - obj : A vector of nb_singleEq objects, where the solved model(s) is/are 
...
% Copyright (c) 2021, Kenneth Sæterhagen Paulsen
    ...
    elseif nobj > 1
        ...
        if obj.options.recursive_estim
            obj.solution = nb_singleEq.solveRecursive(res,opt);
        else
            obj.solution = nb_singleEq.solveNormal(res,opt);
        end
