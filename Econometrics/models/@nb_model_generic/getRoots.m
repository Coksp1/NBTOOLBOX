...
%
% Caution : For recursivly estimed model each period solution is 
%           calculated. See page ModelX (ii), where ii will be the index
...
% Copyright (c) 2023, Kenneth Sæterhagen Paulsen
    ...
    nobj = numel(obj);
    if nobj == 0;
        error('Cannot get the roots of a empty vector of nb_model_generic objects.')
    else
        ...
        for ii = 1:nobj 
            ...
            try
                ...
                error(['Model ' int2str(ii) ' is not solved'])
            end
            ...
            root                  = nb_data([realD,imagD,modulus],['Model',int2str(ii)],1,vars);
