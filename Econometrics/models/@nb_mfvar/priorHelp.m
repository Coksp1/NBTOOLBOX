...
% Syntax:
%
% helpText = nb_mfvar.priorHelp(type)
% helpText = nb_mfvar.priorHelp(type,option,maxChars)
%
% Description:
%
...
% Copyright (c) 2024, Kenneth Sæterhagen Paulsen
    ...
    helper   = nb_writeHelp('nb_mfvar.priorTemplate',option,type,'timeSeries');
