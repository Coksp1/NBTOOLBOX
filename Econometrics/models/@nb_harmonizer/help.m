...
% Syntax:
%
% helpText = nb_harmonizer.help
% helpText = nb_harmonizer.help(option)
% helpText = nb_harmonizer.help(option,maxChars)
%
% Description:
%
...
% Copyright (c) 2024, Kenneth Sæterhagen Paulsen
    ...
    helper   = nb_writeHelp('nb_harmonizer',option,'class','timeseries');
