classdef nb_fmsa < nb_model_generic & nb_factor_model_generic
% Description:
%
...
% Copyright (c) 2021, Kenneth Sæterhagen Paulsen
    ...
    methods
        ...
        function obj = nb_fmsa(varargin)
        % Constructor

            obj             = obj@nb_model_generic();
            temp            = nb_fmsa.template();
    ...
    methods (Hidden)
        ...
        function name = createName(obj)
            ...
            name = ['FM_SA' int2str(obj.options.nStep)];
    ...
    methods(Access=protected)
        ...
        function param = getParametersNames(obj)
            ...
            if nb_isempty(obj.estOptions)
                ...
                secDim = [opt.dependent,nb_cellstrlead(opt.dependent,opt.nStep)]';
