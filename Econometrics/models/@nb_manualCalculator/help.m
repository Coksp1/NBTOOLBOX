...
% Syntax:
%
% helpText = nb_manualCalculator.help
% helpText = nb_manualCalculator.help(option)
% helpText = nb_manualCalculator.help(option,maxChars)
%
% Description:
%
...
%
% Written by Kenneth Sæterhagen Paulsen & Atle Loneland
...
% Copyright (c) 2024, Kenneth Sæterhagen Paulsen
    ...
    helper   = nb_writeHelp('nb_manualCalculator',option,'class','timeSeries');
