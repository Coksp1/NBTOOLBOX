...
% Syntax:
%
% helpText = nb_calculate_vintages.help
% helpText = nb_calculate_vintages.help(option)
% helpText = nb_calculate_vintages.help(option,maxChars)
%
% Description:
%
...
% Copyright (c) 2021, Kenneth Sæterhagen Paulsen
    ...
    helper   = nb_writeHelp('nb_calculate_vintages',option,'class','timeSeries');
