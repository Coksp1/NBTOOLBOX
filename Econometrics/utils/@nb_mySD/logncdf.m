...
% Copyright (c) 2021, Kenneth Sæterhagen Paulsen
    ...
    obj.derivatives = strcat(objDeriv ,'.*nb_distribution.lognormal_pdf', objStrInFunc ,',', mStr, ',', kStr, ')');
    obj.values      = strcat('nb_distribution.lognormal_cdf', objStrInFunc,',', mStr, ',', kStr, ')');
