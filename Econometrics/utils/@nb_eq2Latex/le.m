function obj = le(obj,another,flip)
% Syntax:
%
...
% Copyright (c) 2021, Kenneth Sæterhagen Paulsen
    ...
    if isa(another,'nb_eq2Latex') && isa(obj,'nb_eq2Latex')
        ...
        obj.latex  = [obj.latex '\leq' another.latex];
        obj.values = [obj.values '\leq' another.values];
    ...
    elseif isa(obj,'nb_eq2Latex') && (nb_isScalarNumber(another) || nb_isOneLineChar(another))
        ...
        obj.latex  = [obj.latex '\leq' anotherStr];
        obj.values = [obj.values '\leq' anotherStr];
    ...
    elseif isa(another,'nb_eq2Latex') && (nb_isScalarNumber(obj) || nb_isOneLineChar(obj))
        ...
        obj        = another;
        obj.latex  = [objStr '\leq' another.latex];
        obj.values = [objStr '\leq' another.values];
