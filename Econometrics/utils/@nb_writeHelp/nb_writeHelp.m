    ...
    methods (Access=protected)
        ...
        function obj = algorithm(obj)
            ...
            elseif strcmpi(obj.nameOfPOrC,'nb_midas') || strcmpi(obj.nameOfPOrC,'nb_midasEstimator')
                obj.helpStruct.algorithm = ...
                    ['Sets the algorithm used to estimate the MIDAS model, can be ''unrestricted'', ''beta'' or ',...
                     '''almon'' for unrestricted MIDAS, beta lag MIDAS and almon lag MIDAS respectively.'];
            else
        ...
        function obj = estim_method(obj)
            ...
            switch lower(obj.nameOfPOrC)
                ...
                case 'nb_singleeq'
                    extra = ' Ordinary least squares (''ols''), two stage least squares (''tsls'') or quantile regression (''quantile'').';
                case 'nb_var'
                    extra = [' The supported options are; ordinary least squares (''ols'') , bayesian VAR estimation (''bVar'') ',...
                             'or maximum likelihood estimation (''ml''). If the prior option is set, this option will automatically ',...
                             'be set to ''bVar''.'];
        ...
        function obj = frequency(obj)
            ...
            elseif strcmpi(obj.nameOfPOrC,'nb_midas') || strcmpi(obj.nameOfPOrC,'nb_midasestimator')
                obj.helpStruct.frequency = ...
                    ['Sets the frequency of the dependent variable. As an integer, 1 (yearly) or 4 (quarterly). ',...
        ...
        function obj = hyperprior(obj)
            obj.helpStruct.hyperprior = ...
                ['Set to true to use hyperpriors when doing empirical bayesian. See the empirical',...
        ...
        function obj = lambda(obj)
            if strcmpi(obj.nameOfPOrC,'nb_calculate_hp') || strcmpi(obj.nameOfPOrC,'nb_hpestimator')
                obj.helpStruct.lambda = [...
                    'The hp-filter smoothing parameter. Default is 1600.'];
            else
                obj.helpStruct.lambda = ...
            ...
            elseif strcmpi(obj.nameOfPOrC,'nb_model_group_vintages.aggregateForecast')
                ...
                switch lower(obj.nameOfPOrC)
                    ...
                    case {'nb_midas','nb_midasestimator'}
                        obj.helpStruct.nlags = '';
                        extra                = ['Setting nLags will set the amount of lags used in the regression. ',...
                                                'As a scalar integer. Be aware that the contemporaneous exogenous variables ',...
                                                'is automatically added. If the unbalanced option is set the exogenous regressors ',...
                                                'may be leaded to take into account that the exogenous variables has more  ',...
                                                'observations than the dependent variable.'];
