function [beta,sigma,yDraws] = inwishartMFGibbs(draws,y,x,H,R_prior,initBeta,initSigma,a_prior,V_prior,S_prior,v_post,restrictions,thin,burn,waitbar,maxTries)
% Syntax:
%
% [beta,sigma,yDraws] = nb_bVarEstimator.inwishartMFGibbs(draws,y,x,H,...
%                   R_prior,initBeta,initSigma,a_prior,V_prior,S_prior,...
