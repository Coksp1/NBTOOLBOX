function [beta,sigma,yDraws] = nwishartMFGibbs(draws,y,x,H,R_prior,initBeta,initSigma,a_prior,V_prior_inv,S_prior,v_post,restrictions,thin,burn,waitbar,maxTries)
% Syntax:
%
% [beta,sigma,yDraws] = nb_bVarEstimator.nwishartMFGibbs(draws,y,x,H,...
%           R_prior,initBeta,initSigma,a_prior,V_prior_inv,S_prior,...
...
% Copyright (c) 2021, Kenneth Sæterhagen Paulsen
    ...
    for ii = 1:burn
        ...
        sigmaD = nb_distribution.invwish_rand(S_post,v_post);
        if isWaitbar
