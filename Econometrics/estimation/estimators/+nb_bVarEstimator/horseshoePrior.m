function [Beta,lambda,tau,nu,xi,sigma_sq] = horseshoePrior(y,X,XX,lambda,tau,nu,xi,sigma_sq,type)
% Syntax:
%
...
%             Beta   = sqrt(sigma_sq)*(u+U*v_star);
    ...
    elseif type == 3 % Makalic & Schmidt (2016) parameterization
