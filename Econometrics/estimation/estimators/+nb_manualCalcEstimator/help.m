...
% Syntax:
%
% helpText = nb_manualCalcEstimator.help
% helpText = nb_manualCalcEstimator.help(option)
% helpText = nb_manualCalcEstimator.help(option,maxChars)
%
% Description:
%
...
% Copyright (c) 2024, Kenneth Sæterhagen Paulsen
    ...
    helper   = nb_writeHelp('nb_manualCalcEstimator',option,'package','timeSeries');
