function matches = getVariablesFromRestrictions(harmonizer)
% Syntax:
%
% matches = nb_harmonizeEstimator.getVariablesFromRestrictions(harmonizer)
%
% Description:
%
% Get the variables used in all the restrictions of the harmonizer.
%
