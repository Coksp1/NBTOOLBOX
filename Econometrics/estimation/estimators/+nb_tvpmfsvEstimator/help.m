...
% Syntax:
%
% helpText = nb_tvpmfsvEstimator.help
% helpText = nb_tvpmfsvEstimator.help(option)
% helpText = nb_tvpmfsvEstimator.help(option,maxChars)
%
% Description:
%
...
% Copyright (c) 2024, Kenneth Sæterhagen Paulsen
    ...
    helper   = nb_writeHelp('nb_tvpmfsvEstimator',option,'package','timeSeries');
