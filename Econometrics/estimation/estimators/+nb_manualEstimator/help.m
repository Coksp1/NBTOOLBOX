...
% Syntax:
%
% helpText = nb_manualEstimator.help
% helpText = nb_manualEstimator.help(option)
% helpText = nb_manualEstimator.help(option,maxChars)
%
% Description:
%
...
% Copyright (c) 2024, Kenneth Sæterhagen Paulsen
    ...
    helper   = nb_writeHelp('nb_manualEstimator',option,'package','timeSeries');
