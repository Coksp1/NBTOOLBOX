...
if exitflag == 0
    msg = sprintf('Reached limit of %g iterations', options.MaxIter) ;
elseif exitflag == 1
    ...
    msg = sprintf('%s after %g generations.', msg, output.iterations) ;
elseif exitflag == 2
...
elseif exitflag == -4
    ...
    msg = sprintf('%s after %g generations.', msg, output.iterations) ;
elseif exitflag == -5
    msg = sprintf('Time limit of %s reached.',options.MaxTime) ;
else
