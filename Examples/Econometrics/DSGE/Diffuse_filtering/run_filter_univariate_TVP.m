...
vars = {'y','yc','yt','yn','lambda_c','cc'};
data = nb_ts([y,yc,yt,yn,lambda_c,cc],'','1990Q1',vars);

%% Parse model

model = nb_dsge('nb_file','model2.nb');
...
mest = filter(mest,'kf_method','univariate');
