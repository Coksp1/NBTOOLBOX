...
% is the quarterly estimate of M_VAR2 series.
...
t.dependent = {'VAR1','M_VAR2'};
t.frequency = {'M_VAR2',12};
t.mapping   = {'M_VAR2','diffAverage'}; % Approximation
t.constant  = true;
t.nLags     = 2;
t.prior     = prior;
t.draws     = 500;
...
t           = nb_mfvar.template();
t.data      = data;
t.dependent = {'VAR1','M_VAR2','Q_VAR3'};
t.frequency = {'M_VAR2',12,'Q_VAR3',4};
t.mapping   = {'M_VAR2','diffAverage','Q_VAR3','diffAverage'};
t.constant  = true;
t.nLags     = 2;
t.prior     = prior;
t.draws     = 500;
...
% Without history
[fcstData,fcstPercData] = getForecastLowFreq(modelF,12)

% With history
[fcstData,fcstPercData] = getForecastLowFreq(modelF,12,'',true)
