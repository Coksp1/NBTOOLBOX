...
% Copyright (c) 2021, Kenneth Sæterhagen Paulsen
    ...
    gui.smartVar = uicontrol(gui.smartPanel,...
        ...
        'background',   [1 1 1],....
        'string',       {''});
    yLevelVint = yLevelVar - smartListHeight - spaceY; 
    uicontrol(gui.smartPanel,...
        'style',        'text',...
        'units',        'normal',...
        'position',     [textStart yLevelVint + (smartListHeight-Height) textWidth Height],...
        'string',       'Contexts');    
    gui.smartVint = uicontrol(gui.smartPanel,...
        'style',        'listbox',...
        'units',        'normal',...
        'position',     [boxStart yLevelVint boxWidth smartListHeight],...
        'background',   [1 1 1],....
        'string',       {''});
