...
% Description:
%
% Part of DAG. Callback function for when the radiobutton choice in the 
% lag length buttongroup changes. Enables/disables choices depending on 
% whether the user selects manual or automatic lag length.
% 
...
% Copyright (c) 2024, Kenneth Sæterhagen Paulsen
    ...
    % Get components
    % autSelectBtn = gui.lagPanelComponents.autSelectBtn;
