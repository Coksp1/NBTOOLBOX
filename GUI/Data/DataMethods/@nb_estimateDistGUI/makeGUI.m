...
%     startB    = startPopX + widthPop + startTX;
    ...
    gui.pop1 = uicontrol(...
              ...
              'horizontalAlignment','left',...
              'Interruptible',      'off',...
              'userData',           {'mle','mme','kernel','hist'},...
              'string',             {'Maximum likelihood','Method of moments','Kernel','Histogram'},...
              'callback',           @gui.estimatorCallback);               
    ...
    gui.pop3 = uicontrol(...
              ...
              'Interruptible',      'off',...
              'string',             {'1','2','3'},...
              'callback',           @gui.dimensionCallback);      
