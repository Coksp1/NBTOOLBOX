...
% Copyright (c) 2021, Kenneth Sæterhagen Paulsen
    ...
    if isa(parent,'nb_GUI')
        name = [parent.guiName ': Band Pass-Filter'];
    else
    ...
    uicontrol(...
              'units',                  'normalized',...
              'position',               [startTX, heightPop*(kk-1) + spaceYPop*kk + extra + moveUp, widthT, heightT],...
              'parent',                 f,...
              'style',                  'text',...
    ...
    gui.edit1 = uicontrol(...
              'units',              'normalized',...
              'position',           [startPopX, heightPop*(kk-1) + spaceYPop*kk + moveUp, widthPop, heightPop],...
              'parent',             f,...
              'background',         [1 1 1],...
              'style',              'edit',...
              ...
              'Interruptible',      'off',...
              'string',             '8',...
              'callback',           @gui.bk1ChangedCallback);
    
    kk = kk - 1;      
    uicontrol(...
              'units',                  'normalized',...
              'position',               [startTX, heightPop*(kk-1) + spaceYPop*kk + extra + moveUp*3, widthT, heightT],...
              'parent',                 f,...
              'style',                  'text',...
              'horizontalAlignment',    'left',...
              'string',                 'Upper Bound');
    ...
    gui.edit4 = uicontrol(...
              'units',              'normalized',...
              'position',           [startPopX, heightPop*(kk-1) + spaceYPop*kk + moveUp*3, widthPop, heightPop],...
              'parent',             f,...
              'background',         [1 1 1],...
              'style',              'edit',...
              'horizontalAlignment','right',...
              'Interruptible',      'off',...
              'string',             '32',...
              'callback',           @gui.bk2ChangedCallback);      
    
    % Output Panel
    %--------------------------------------------------------------
    panelWidth  = widthPop + widthT + startTX;
