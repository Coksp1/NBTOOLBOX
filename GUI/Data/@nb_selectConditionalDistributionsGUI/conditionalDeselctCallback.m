function conditionalDeselctCallback(gui,~,~)
% Syntax:
%
% conditionalDeselctCallback(gui,hObject,event)
%
% Description:
%
% Part of DAG.
...
% Copyright (c) 2024, Kenneth Sæterhagen Paulsen
    ...
    mm = figure('visible',        'off',...
                ...
                'name',           'Deselect hard condition on variables',...
                'numberTitle',    'off',...
                'menuBar',        'None',...
                'windowStyle',    'modal',...
                'toolBar',        'None',...
