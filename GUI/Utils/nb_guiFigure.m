function [f,defaultBackground] = nb_guiFigure(mainGUI,name,positions,windowStyle,resize,callback,func)
% Syntax:
%
% [f,defaultBackground] = nb_guiFigure(mainGUI,name,positions,...
%       windowStyle,resize,callback,func)
%
% Description:
%
