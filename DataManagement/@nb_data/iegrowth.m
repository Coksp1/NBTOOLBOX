function obj = iegrowth(obj,initialValues,periods)
% Syntax:
%
...
% the inverse method of the egrowth method of the nb_data class
% 
% Input:
% 
...
% Copyright (c) 2024, Kenneth Sæterhagen Paulsen
    ...
    if obj.isUpdateable()
        ...
        % object
        obj = obj.addOperation(@iegrowth,{initialValues,periods});
