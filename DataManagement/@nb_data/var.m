...
% Description:
%
% Calculate the var of each series. The result will be an 
% object of class nb_ts where all the non-nan values of 
% all the series are beeing set to their var.
% 
...
%                    series are beeing set to their var. 
% 
