...
% Output:
% 
% - obj       : An nb_data object where all the variables are from 
%               the first object are substracted from the other.
%
%               Or
%
%               An nb_data object where the scalar are substracted
%               from all the elements of the input object
%
%               Or 
%
%               An nb_data object where all the elements of the input 
...
% Copyright (c) 2024, Kenneth Sæterhagen Paulsen
    ...
    if ~isa(DBOrNum,'nb_data') && ~isscalar(DBOrNum)
