...
% Output:
% 
% - obj       : An nb_data object where the data from th one object 
%               are raised with the data from the other object
%
%               or
%
%               An nb_data object where all the elements are 
%               raised by the scalar DBOrNum. 
%
%               or
%
%               An nb_data object where the scalar obj are raised by
...
% Copyright (c) 2023, Kenneth Sæterhagen Paulsen
    ...
    elseif isscalar(obj) && isnumeric(obj)
