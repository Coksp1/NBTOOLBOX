...
% Copyright (c) 2021, Kenneth Sæterhagen Paulsen
    ...
    if isempty(out)
        ...
        F = nb_data(F,'',obj.startDate,varsPC,obj.sorted);
        if obj.isUpdateable()
            F.links      = obj.links;
            F.updateable = 1;
        ...
        if nargout > 3    
            ...
            varF = nb_cs(varF,'',{'Variance'},varsPC,obj.sorted);
            if obj.isUpdateable()
        ...
        if nargout > 4    
            % Variance of each factor 
            expl = nb_cs(expl,'',{'Explained'},varsPC,obj.sorted);
            if obj.isUpdateable()
        ...
        if nargout > 7   
            % Scaling factor of equation of equation
            e = nb_data(e,'',obj.startDate,vars,obj.sorted);
            if obj.isUpdateable()
                e.links      = obj.links;
                e.updateable = 1;
        ...
        if nargout > 8   
            % Scaling factor of equation of equation
            Z = nb_data(Z,'',obj.startDate,vars,obj.sorted);
            if obj.isUpdateable()
                Z.links      = obj.links;
                Z.updateable = 1;
        ...
        switch lower(out)
            ...
            case 'varf'
                % Variance of each factor 
                F = nb_cs(varF,'',{'Variance'},varsPC,obj.sorted);
            case 'expl'
                % Variance of each factor 
                F = nb_cs(expl,'',{'Explained'},varsPC,obj.sorted);
            case 'c'
                % Constant term of equation
            ...
            case 'e'
                % Scaling factor of equation of equation
                F = nb_data(e,'',obj.startDate,vars,obj.sorted);
            case 'Z'
                % Scaling factor of equation of equation
                F = nb_data(Z,'',obj.startDate,vars,obj.sorted);    
            otherwise
