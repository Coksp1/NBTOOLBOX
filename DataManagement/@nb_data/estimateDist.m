...
%               If 'nb_dataSource' is choosen the output will be a nb_data
...
% Copyright (c) 2023, Kenneth Sæterhagen Paulsen
    ...
    if strcmpi(output,'nb_dataSource')  
        ...
        if dim == 2
            dist = nb_data(dist,obj.dataNames,obj.startObs,{'Cross_variables'});
        elseif dim == 3
            dist = nb_data(dist,obj.dataNames(1),obj.startObs,obj.variables);
        else
            dist = nb_cs(dist,obj.dataNames,'Cross_observations',obj.variables);
        end
