function obj = ipcn(obj,initialValues,periods)
% Syntax:
%
...
% growth, i.e. the inverse method of the pcn method of the nb_data 
% class
% 
% Input:
% 
...
% Copyright (c) 2023, Kenneth Sæterhagen Paulsen
    ...
    if obj.isUpdateable()
        ...
        % object
        obj = obj.addOperation(@ipcn,{initialValues,periods});
