function obj = ones(start,obs,vars,pages,sorted)
% Syntax:
%
% obj = nb_bd.ones()
...
% Copyright (c) 2024, Kenneth Sæterhagen Paulsen
    ...
    [locations,indicator,~] = nb_bd.getLocInd(ones(obs,svars,pages));
    
    % Create nb_bd object with NaNs
    obj = nb_bd(ones(obs,svars,pages),'',start,vars,locations,indicator,sorted);
