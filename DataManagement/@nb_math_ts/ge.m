...
% Description:
% 
% Test if the one object is greater or equal to the other object 
...
%               the data elemets of object a are greater or equal 
%               to the data elements of object b, otherwise 0.  
%             
% Examples:
%
% obj = a >= b;
...
% Copyright (c) 2024, Kenneth Sæterhagen Paulsen
    ...
    elseif isa(a,'nb_math_ts') && isa(b,'double')
        ...
        if isscalar(b)
            ...
            error([mfilename ':: Undefined function ''ge'' for input arguments of type ''' class(a) '''  and ''' class(b) ' vector''.'])
    ...
    elseif isa(a,'double') && isa(b,'nb_math_ts')
        ...
        error([mfilename ':: Undefined function ''ge'' for input arguments of type ''' class(a) ''' and ''' class(b) '''.'])
    end
