...
% Description:
% 
% Test if the two objects are not equal elemetswise and return a 
...
%               the different data elemets are not equal, otherwise
%               0.  
%             
% Examples:
%
...
% Copyright (c) 2021, Kenneth Sæterhagen Paulsen
    ...
    elseif isa(a,'nb_math_ts') && isa(b,'double')
        ...
        if isscalar(b)
            ...
            error([mfilename ':: Undefined function ''ne'' for input arguments of type ''' class(a) '''  and ''' class(b) ' vector''.'])
