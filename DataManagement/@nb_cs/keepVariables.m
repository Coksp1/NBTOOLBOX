...
% Description:
%
% Keep variables from the current nb_cs object (letter size 
% has somthing to say)
%
...
%     or cellstr array keptVar, of current the nb_cs object.
% 
%     NB! If keptVar is just one string and include a * as the 
%           last letter, this function will keep all the variable 
...
% Output: 
%
% - obj         : A nb_cs object with the variables specified in 
%                 the input keptVar kept, all the others are 
%                 deleted.
% 
% Examples:
%
...
% Copyright (c) 2023, Kenneth Sæterhagen Paulsen
    ...
    if isempty(obj.variables)
        warning('nb_cs:keepVariables:empty',[mfilename,':: The object dosen''t contain any variables, no variables to be kept']) 
    end
