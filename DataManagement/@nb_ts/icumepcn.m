function obj = icumepcn(obj,initialValues)
% Syntax:
%
% obj = icumepcn(obj,initialValues)
%
% Description:
%
% Construct indicies based on initial values and timeseries wich 
% represent the series cumulative growth. Inverse percentage cumulative 
% growth, i.e. the inverse method of the cumepcn method of the nb_ts class
% 
% Input:
% 
...
%
% obj = icumepcn(obj);
% obj = icumepcn(obj,100);
% obj = icumepcn(obj,[78,89]);
% 
% See also
% nb_ts.cumepcn, nb_ts.epcn
%
...
% Copyright (c) 2024, Kenneth Sæterhagen Paulsen
    ...
    if t == 1  
        obj.data = nb_icumepcn(obj.data,d0,true);
    else
        d                   = obj.data(t:end,:,:);
        d                   = nb_icumepcn(d,d0,true);
    ...
    if obj.isUpdateable()
        ...
        % object
        obj = obj.addOperation(@icumepcn,{initialValues});
