function obj = iepcn(obj,initialValues,periods,startAtNaN)
% Syntax:
%
% obj = iepcn(obj,initialValues,periods)
% obj = iepcn(obj,initialValues,periods,startAtNaN)
%
% Description:
%
...
% i.e. the inverse method of the epcn method of the nb_ts class
% 
% Input:
% 
...
% Copyright (c) 2024, Kenneth Sæterhagen Paulsen
    ...
    if t == 1  
        obj.data = iepcnnan(obj.data,d0,periods);
    else
        d                   = obj.data(t:end,:,:);
        d                   = iepcnnan(d,d0,periods);
    ...
    if obj.isUpdateable()
        ...
        % object
        obj = obj.addOperation(@iepcn,{initialValues,periods,startAtNaN});
