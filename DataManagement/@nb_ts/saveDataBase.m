...
% Copyright (c) 2023, Kenneth Sæterhagen Paulsen
    ...
    switch lower(foundExt)
        ...
        case 'xlsx'
            ...
            for ii = 1:obj.numberOfDatasets
                ...
                if strcmpi(foundStrip,'on')
                    ...
                    ind         = all(isnan(d),2);
                    d           = d(~ind,:);
                    datesOfData = obj.startDate.toDates(0:obj.numberOfObservations - 1,foundDateFormat,obj.frequency);
                    datesOfData = datesOfData(~ind,1);
                    dataset     = [{'Time'}, obj.variables; datesOfData, num2cell(d)];
                else
                    datesOfData   = obj.startDate.toDates(0:obj.numberOfObservations - 1,foundDateFormat,obj.frequency);
                    dataset = [{'Time'}, obj.variables; datesOfData, num2cell(obj.data(:,:,ii))];
                end
        ...
        case 'txt'
            ...
            datesOfData = obj.startDate:obj.endDate;
