...
% Description:
%
% Sets all values of the given variables of a nb_ts object, except a given  
% amount of observations at the end, to nan.
% 
% Input: 
%
% - obj        : A nb_ts object
...
% Copyright (c) 2024, Kenneth Sæterhagen Paulsen
    ...
    if isempty(obj)
        ...
        warning('nb_ts:EmptyObject',[mfilename ':: The object you are trying to strip observatiosns of is empty. Returning an empty object.']);
        return
    ...
    if ~isempty(variables)
        ...
        for ii = 1:max(size(variables))
            ...
            if sum(var_id)==0
                warning('nb_ts:window:VariableNotFound',[mfilename ':: Variable ''' variables{ii} ''' not found.']) 
            end
        end
