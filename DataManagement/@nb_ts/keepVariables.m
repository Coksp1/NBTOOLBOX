...
% Description:
% 
% Keep variables from the current nb_ts object (letter size 
...
% Output: 
%
% - obj : An nb_ts object with the variables specified in input
...
% Copyright (c) 2023, Kenneth Sæterhagen Paulsen
    ...
    if isempty(obj.variables)
        warning('nb_ts:keepVariables:empty',[mfilename,':: The object dosen''t contain any variables, no variables to be kept']) 
    end
