function obj = splitSeries(obj,variable,date,postfix,overlapping)
% Syntax:
%
...
%                 cellstr.
%
% - date        : The date to split the series. Either as a string
%                 or a nb_date object. Local variables 
%                 syntax is supported.
%
...
% Output:
% 
% - obj      : An object of class nb_ts with the splitted series
%              added.
%
% See also:
...
% Copyright (c) 2024, Kenneth Sæterhagen Paulsen
    ...
    sDate      = interpretDateInput(obj,date);
    ...
    if obj.isUpdateable()
        ...
        % object
        obj = obj.addOperation(@splitSeries,{variable,date,postfix,overlapping});
