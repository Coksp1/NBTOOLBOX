...
% Description:
% 
% Test if the one object is greater than or equal to (>=) the other object  
% elemetswise and return a nb_dataSource object where each element are 1 
% if true, otherwise 0. 
%
