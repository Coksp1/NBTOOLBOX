...
% dataset (page) of the DB property of the nb_graph_ts object.
% 
% Input:
% 
...
% Copyright (c) 2021, Kenneth Sæterhagen Paulsen
    ...
    for ii = iterated
        ...
        if ~isempty(obj.dataToGraphRight)
            % Here we don't update the properties 'dates' and 'xTick'
            [obj,obj.dataToGraphRight] = interpretMissingData(obj,obj.dataToGraphRight,0); 
        end
        ...
        % Make the axes handle
        %----------------------------------------------------------
        obj.axesHandle = nb_axes('fast',                obj.axesFast,...
                                 'parent',              obj.figureHandle(kk),...
                                 'position',            obj.position,...
                                 'UIContextMenu',       obj.UIContextMenu,...
