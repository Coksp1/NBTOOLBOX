...
% Copyright (c) 2021, Kenneth Sæterhagen Paulsen
    ...
    %--------------------------------------------------------------
    % Evaluate multiplication options
    %--------------------------------------------------------------
    obj.dataToGraph = obj.DB.data*obj.factor;
    ...
    %--------------------------------------------------------------
    if strcmpi(obj.graphStyle,'presentation') || strcmpi(obj.graphStyle,'presentation_white')
