...
% produced by an object of class nb_graph_subplot.
%
...
%                   object of class nb_graph_subplot. As an 
%                   integer.
%     
% Examples:
% 
...
% Copyright (c) 2024, Kenneth Sæterhagen Paulsen
    ...
    for ii = 1:numOfGraphs
        ...
        if obj.subPlotSpecial
            ...
            if obj.subPlotSize(2) == 2 && obj.subPlotSize(1) == 1
        ...
        if strcmpi(theme,'NorgesBankNew')
            ...
            if obj.subPlotSpecial
                ...
                if obj.subPlotSize(2) == 1 && obj.subPlotSize(1) == 2
                    code = char(code,['   \\centerline{ \\includegraphics<1>[width=0.6\\contentwidth,height=\\contentheight]{' obj.saveName '_' int2str(ii) '.' format '}}\r\n']);
                elseif obj.subPlotSize(2) == 2 && obj.subPlotSize(1) == 1
                    code = char(code,['   \\centerline{ \\includegraphics<1>[width=\\contentwidth,height=0.6\\contentheight]{' obj.saveName '_' int2str(ii) '.' format '}}\r\n']);
                else
                    code = char(code,['   \\centerline{ \\includegraphics<1>[width=\\contentwidth,height=\\contentheight]{' obj.saveName '_' int2str(ii) '.' format '}}\r\n']);
                end
            ...
            code = char(code,['   \\centerline{ \\includegraphics<1>[width=\\textwidth,height=0.8\\textheight]{' obj.saveName '_' int2str(ii) '.' format '}}\r\n']);    
        end
        ...
        if strcmpi(theme,'NorgesBankNew')
            ...
            if not(isempty(footer) && isempty(source))
                ...
                for jj = 1:numFooters
                    ...
                    switch jj
                        case 1
                            code = char(code,['   \\footlineleft{\\scriptsize ' footer{end} '}\r\n']);
                        case 2
                            code = char(code,['   \\footlineleftSecond{\\scriptsize ' footer{numFooters - 1} '}\r\n']);
                        case 3
                            code = char(code,['   \\footlineleftThird{\\scriptsize ' footer{numFooters - 2} '}\r\n']);
                        case 4
                            code = char(code,['   \\footlineleftFourth{\\scriptsize ' footer{numFooters - 3} '}\r\n']);
                        otherwise
                ...
                for jj = 1:numSources
                    ...
                    switch jj
                        case 1
                            code = char(code,['  \\footlineright{\\scriptsize ' source{end} '}\r\n']);
                        case 2
                            code = char(code,['  \\footlinerightSecond{\\scriptsize ' source{numSources - 1} '}\r\n']);
                        case 3
                            code = char(code,['  \\footlinerightThird{\\scriptsize ' source{numSources - 2} '}\r\n']);
                        case 4
                            code = char(code,['  \\footlinerightFourth{\\scriptsize ' source{numSources - 3} '}\r\n']);
                        otherwise
