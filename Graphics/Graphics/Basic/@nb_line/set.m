...
% Description:
% 
% Sets the properties of an object of class nb_line. Give the 
...
% Output:
% 
% - obj      : The same object of class nb_line with the given
%              properties reset
% 
% Examples:
% 
