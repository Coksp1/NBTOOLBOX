...
% Description:
% 
% Sets the properties of an object of class nb_horizontalLine. Give  
...
% Output:
% 
% - obj      : The same object of class nb_horizontalLine with the 
            ...
            switch propertyName
                ...
                case 'ydata'
                    ...
                    if isscalar(propertyValue)
                        ...
                        error([mfilaname ':: The property ''yData'' must be a scalar.'])
                    end
