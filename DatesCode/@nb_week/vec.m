...
%
% end   : An nb_week object or a double, representing the end date or the
...
% Copyright (c) 2021, Kenneth Sæterhagen Paulsen
    ...
    if isa(endD, 'nbweek') && ~(length(obj) == length(endD))
    ...
    if length(obj) == 1
        ...
        elseif isa(endD,'double') 
            ...
            error([mfilename '::Wrong input format for endD. Must be either an nb_week '...
                  'object or a double. '])
        ...
        out = toDates(obj,periods,'nb_date',52,1);    
    else
