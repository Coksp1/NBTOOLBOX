...
% Description:
%
% Convert the nb_semiAnnual object ot the wanted frequency. The  
% return variable will be an object which is of an subclass of the
% nb_date class.
% 
% Input:
% 
...
% Copyright (c) 2021, Kenneth Sæterhagen Paulsen
    ...
    switch frequency   
        ...
        case 2
            % Do nothing
        case 4
            obj = obj.getQuarter(first);
        case 12
            obj = obj.getMonth(first);
        case 52
